...
# This part is image labels setting start 
        ...
        # first header image  
        img=Image.open(r"Images_GUI\uvpce2.jpeg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Face Recognition Attendance Managment System",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1.place(x=260,y=100,width=180,height=180)
        ...
        std_b1_1.place(x=260,y=280,width=180,height=45)
        ...
        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Recognition",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        tra_b1.place(x=260,y=330,width=180,height=180)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=260,y=510,width=180,height=45)

        # Photo   button 5
        pho_img_btn=Image.open(r"Images_GUI\photo.jpg")
