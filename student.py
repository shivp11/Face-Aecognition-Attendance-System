...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CE","IT","ME","CE-AI","Chemical Engineering", "Bsc", "Msc")
        dep_combo.current(0)
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Duration",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        cou_combo["values"]=("Select Course","2 Year","3 Year","4 Year","5 Year")
        cou_combo.current(0)
