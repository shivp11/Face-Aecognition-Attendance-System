...
# This part is image labels setting start 
        ...
        det_img_btn=Image.open(r"Images_GUI\Shiv.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Shiv Patel",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"Images_GUI\Het.jpg")
        ...
        att_b1_1 = Button(bg_img,text="Het Shah",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
